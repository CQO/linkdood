...
fs.writeFileSync(
  path.join(__dirname, `../../app/components/${routeName}View.vue`),
  routeTemplate
)

fs.mkdirSync(path.join(__dirname, `../../app/components/${routeName}View`))
...
console.log('  [ \n' + [
  '    ' + path.join(__dirname, `../../app/components/${routeName}View.vue`),
  path.join(__dirname, `../../app/components/${routeName}View`),
  path.join(__dirname, '../../app/routes.js'),
].join(',\n    ') + '\n  ]')
