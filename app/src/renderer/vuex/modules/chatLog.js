...
let state = {
  contacts:{},
  chatList:[
    { item: '10001',id:"10001",lastMessage:'你只要在桌面上点击鼠标右键，选择“新建文件夹”就行了。All you have to do is right-click on the desktop and select New Folder',time:'10001' },
    { item: '10002',id:"10002",lastMessage:'测试',time:'10002' },
    { item: '10004',id:"10004",lastMessage:'哦哦',time:'10004' }
  ],
  sessions:{
